...
#define BABYSTEPPING
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  18       // (steps or mm) Steps or millimeter distance for each Z babystep
  #define BABYSTEP_MULTIPLICATOR_XY 18       // (steps or mm) Steps or millimeter distance for each XY babystep
